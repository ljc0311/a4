...
**用户故事：** 作为视频创作者，我希望当选择英文配音时，系统能够自动将中文原文翻译为英文，以便生成准确的英文语音和字幕。

#### 验收标准

1. WHEN 用户选择英文配音且原文为中文 THEN 系统应使用LLM将中文原文翻译为英文
2. WHEN 翻译完成 THEN 系统应将英文译文保存到项目数据库中
3. WHEN 生成英文语音 THEN 系统应使用翻译后的英文文本而非原始中文文本
4. WHEN 生成字幕 THEN 系统应使用保存在数据库中的英文译文
5. WHEN 翻译失败 THEN 系统应提供手动编辑选项或重新翻译功能
